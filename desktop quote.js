...
*/
    ...
    line + space + "DESKTOP DETAILS" + line + "\n" +
    "Motherboard: " + (e.field("motherboard") || "Not specified") + "\n" +
    ...
    "KB / MS: " + (e.field("kb / ms") || "Not specified") + "\n" +
    "Case: " + (e.field("case") || "Not specified") + "\n" +
    "Monitor: " + (e.field("monitor") || "Not specified") + "\n" +
    "OS Version: " + (e.field("os version") || "Not specified") + "\n" +
    line1 + "\n" +
    ...
    (e.field("Office") || e.field("printer") || e.field("other") ? (
      line + space + "OPTIONAL EXTRAS" + line + "\n\n" +
      (e.field("Office") ? "Microsoft Office: " + e.field("Office") + " $" + parseFloat(e.field("office sell price") || 0).toFixed(2) + "\n" : "") +
      (e.field("printer") ? "- Printer: " + e.field("printer") + " $" + parseFloat(e.field("printer sell price") || 0).toFixed(2) + "\n" : "") +
      (e.field("other") ? "- Other: " + e.field("other") + " $" + parseFloat(e.field("other sell price") || 0).toFixed(2) + "\n" : "")
    ) : "") +
    (e.field("desktop pc message") || "Thank you for your inquiry.") + "\n\n" +
    (e.field("signature") || "")
  );
}
// -----------------------------------------
